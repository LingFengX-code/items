...
import com.heifeng.search.client.BrandClient;
import com.heifeng.search.client.CategoryClient;
import com.heifeng.search.client.GoodsClient;
import com.heifeng.search.client.SpecificationClient;
...
public class SearchService {
    ...
    private static final ObjectMapper MAPPER = new ObjectMapper();  //把集合转为json类型的字符串
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        // 查询出所有的搜索规格参数
        List<SpecParam> params = this.specificationClient.querySpecParamsByGid(null, spu.getCid3(), null, true);
        // 查询spuDetail。获取规格参数值
    ...
    private String chooseSegment(String value, SpecParam p) {
        ...
        String result = "其它";
        // 保存数值段
        for (String segment : p.getSegments().split(",")) {//用，号来获取一个区间
    ...
    private List<Map<String,Object>> getParamAggResult(Long id, QueryBuilder boolQueryBuilder) {
        ...
        queryBuilder.withQuery(boolQueryBuilder);
        // 查询要聚合的规格参数
        List<SpecParam> params = this.specificationClient.querySpecParamsByGid(null, id, null, true);
        // 添加聚合
        params.forEach(param -> {
    ...
    public void createDocument(Long id) throws IOException {
